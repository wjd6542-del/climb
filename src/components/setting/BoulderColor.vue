...
export default {
  ...
  methods: {
    ...
    async loadList() {
      this.rowData = [];
      const res = await api.post("/api/boulderColor/list", this.search);
      ...
      this.columnDefs = [
        {
          headerName: this.$t("색상명"),
          field: "name",
          filter: "agTextColumnFilter",
          flex: 0.5,
        },
        {
          headerName: this.$t("색상코드"),
          field: "code",
          filter: "agTextColumnFilter",
          flex: 0.5,
        },
    ...
    async saveRows() {
      ...
      try {
        ...
        await api.post("/api/boulderColor/batchSave", rows);
    ...
    async deleteRows() {
      ...
      try {
        await api.post("/api/boulderColor/batchDelete", rows);
